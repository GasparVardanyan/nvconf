...
vim.api.nvim_create_autocmd('LspAttach', {
	...
	callback = function(args)
		...
		map ("n", "<leader>fI", telescope.lsp_incoming_calls, { buffer = args.buf })
		map ("n", "<leader>fO", telescope.lsp_outgoing_calls, { buffer = args.buf })
		map ("n", "<leader>fS", telescope.lsp_dynamic_workspace_symbols, { buffer = args.buf })
		map ("n", "<leader>fT", telescope.lsp_type_definitions, {buffer = args.buf})
		map ("n", "<leader>fd", telescope.lsp_definitions, { buffer = args.buf })
		map ("n", "<leader>fi", telescope.lsp_implementations, { buffer = args.buf })
		map ("n", "<leader>fr", telescope.lsp_references, { buffer = args.buf })
		map ("n", "<leader>fs", telescope.lsp_document_symbols, { buffer = args.buf })
