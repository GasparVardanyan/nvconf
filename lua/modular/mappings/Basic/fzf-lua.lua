...
map ("n", "<leader>f;", FzfLua.commands, { desc = "commands" })
...
-- map ("n", "<leader>fgg", FzfLua.grep_string, { desc = "grep string" })
...
map ("n", "<leader>fo", function () FzfLua.oldfiles { cwd = vim.fn.getcwd (), include_current_session = true } end, { desc = "oldfiles" })
